...
En la segunda parte de este curso nos enfocaremos principalmente en la aplicación de estas herramientas en **$\color{blue}{\text{Spatial data analyst}}$**, **$\color{blue}{\text{multivariate data analysis}}$** y **$\color{blue}{\text{GIS development}}$**.
